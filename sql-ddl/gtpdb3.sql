...
--
-- Host: localhost
-- Generation Time: Mar 27, 2023 at 05:57 AM
...
(10, 'josh', 'josh@gmail.com', '689e064e6a5ff0dc90387bdaa52f2fba', 1, 1),
(11, 'mac', 'mac@gmail.com', '1bb733b9a65d790c49ff5bf93b76fdff', 1, 1),
(15, 'testuser', 'test@gmail.com', '098f6bcd4621d373cade4e832627b4f6', 0, 0);
...
INSERT INTO `comments` (`id`, `account_id`, `product_id`, `comment`, `rating`) VALUES
(25, 11, 2, 'I love this apple!', 3),
(26, 10, 1, 'these are amazing apples! ', 2),
(27, 10, 1, 'wait i take it back ', 1),
(28, 10, 3, 'granny does love these', 3),
(29, 15, 3, 'wow my grandma gave me a crisp high five after these apple ', 3);
...
ALTER TABLE `comments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `comments_ibfk_1` (`account_id`),
